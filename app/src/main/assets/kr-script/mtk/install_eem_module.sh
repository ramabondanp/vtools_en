...
echo 'Note: Make sure you have completed stability testing!' 1>&2
echo 'Warning: Make sure you have completed the stability test!' 1>&2
echo '' 1>&2
echo 'The operation will start in 5 seconds...' 1>&2
...
echo ''
echo 'This module runs within 120 seconds after boot'
